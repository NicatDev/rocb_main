...
from .views import about_region_list, register_meeting, meeting_registrations, set_language, home, news_page, events_detail, news_detail, events_page, meeting_documents, meeting_documents_single, search
